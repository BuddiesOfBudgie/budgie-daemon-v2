...
namespace bd {
    ...
    private:
        ...
        static void registryHandleGlobalStatic(void *data, wl_registry *reg, uint32_t name, const char *interface,
                                               uint32_t version);
    };
    ...
    public:
        WaylandOutputConfigurationHead(QObject *parent, WaylandOutputHead *head,
