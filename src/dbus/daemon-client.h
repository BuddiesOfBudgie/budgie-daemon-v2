...
#ifndef __sdbuscpp__src_dbus_daemon_client_h__proxy__H__
#define __sdbuscpp__src_dbus_daemon_client_h__proxy__H__
...
protected:
    ...
    virtual void onGetCurrentOutputDetailsReply(const std::string& name, const int32_t& width, const int32_t& height, const int32_t& x, const int32_t& y, const double& scale, const int32_t& refresh, const bool& preferred, const bool& enabled, const sdbus::Error* error) = 0;
