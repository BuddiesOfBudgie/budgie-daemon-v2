...
#ifndef __sdbuscpp__src_dbus_daemon_server_h__adaptor__H__
#define __sdbuscpp__src_dbus_daemon_server_h__adaptor__H__
...
private:
    ...
    virtual void GetCurrentOutputDetails(sdbus::Result<std::string, int32_t, int32_t, int32_t, int32_t, double, int32_t, bool, bool>&& result, std::string serial) = 0;
